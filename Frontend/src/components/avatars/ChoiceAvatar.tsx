...
export default function ChoiceAvatar({setAvatar, membro,setMembro}: {setAvatar: Function, membro: any, setMembro: Function}) {
    ...
    const handleChoice = (event: any,choice: string) => {
        setChoiceAvatar(choice);
        const children = (event.target.parentElement.parentElement.parentElement.children)
        for(let child of children){
            child.classList.remove('border-violet-500');
            child.classList.remove('border-4');
            child.classList.remove('rounded-full');

        }

        event.target.parentElement.parentElement.classList.add('border-violet-500');
        event.target.parentElement.parentElement.classList.add('border-4');
        event.target.parentElement.parentElement.classList.add('rounded-full');
        ...
        <div className="absolute top-0 left-0 w-[880px] h-full bg-black bg-opacity-60 rounded-lg">
            <div className="fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[580px] shadow-lg shadow-black/25  ">
                ...
                <div className="flex flex-wrap py-4 gap-4 items-center justify-center">
                    <button className="transition duration-200 hover:scale-110 " onClick={(event) => handleChoice(event,'/avatars/avatar001.png')}>
                        <Avatar alt="Amanda Souza" src="/avatars/avatar001.png" sx={{ width: '7vw', height: '7vw', bgcolor: '#C0C0C0', fontSize: '5vw' }} />
                    </button>
                    <button className="transition duration-200 hover:scale-110" onClick={(event) => handleChoice(event,'/avatars/avatar002.png')}>
                        <Avatar alt="Amanda Souza" src="/avatars/avatar002.png" sx={{ width: '7vw', height: '7vw', bgcolor: '#C0C0C0', fontSize: '5vw' }} />
                    </button>
                    <button className="transition duration-200 hover:scale-110" onClick={(event) => handleChoice(event,'/avatars/avatar003.png')}>
                        <Avatar alt="Amanda Souza" src="/avatars/avatar003.png" sx={{ width: '7vw', height: '7vw', bgcolor: '#C0C0C0', fontSize: '5vw' }} />
                    </button>
                    <button className="transition duration-200 hover:scale-110" onClick={(event) => handleChoice(event,'/avatars/avatar004.png')}>
                        <Avatar alt="Amanda Souza" src="/avatars/avatar004.png" sx={{ width: '7vw', height: '7vw', bgcolor: '#C0C0C0', fontSize: '5vw' }} />
                    </button>
                    <button className="transition duration-200 hover:scale-110" onClick={(event) => handleChoice(event,'/avatars/avatar005.png')}>
                        <Avatar alt="Amanda Souza" src="/avatars/avatar005.png" sx={{ width: '7vw', height: '7vw', bgcolor: '#C0C0C0', fontSize: '5vw' }} />
                    </button>
                    <button className="transition duration-200 hover:scale-110" onClick={(event) => handleChoice(event,'/avatars/avatar006.png')}>
                        <Avatar alt="Amanda Souza" src="/avatars/avatar006.png" sx={{ width: '7vw', height: '7vw', bgcolor: '#C0C0C0', fontSize: '5vw' }} />
                    </button>
                    <button className="transition duration-200 hover:scale-110" onClick={(event) => handleChoice(event,'/avatars/avatar007.png')}>
                        <Avatar alt="Amanda Souza" src="/avatars/avatar007.png" sx={{ width: '7vw', height: '7vw', bgcolor: '#C0C0C0', fontSize: '5vw' }} />
                    </button>
                    <button className="transition duration-200 hover:scale-110" onClick={(event) => handleChoice(event,'/avatars/avatar008.png')}>
                        <Avatar alt="Amanda Souza" src="/avatars/avatar008.png" sx={{ width: '7vw', height: '7vw', bgcolor: '#C0C0C0', fontSize: '5vw' }} />
                    </button>
                    <button className="transition duration-200 hover:scale-110" onClick={(event) => handleChoice(event,'/avatars/avatar009.png')}>
                        <Avatar alt="Amanda Souza" src="/avatars/avatar009.png" sx={{ width: '7vw', height: '7vw', bgcolor: '#C0C0C0', fontSize: '5vw' }} />
                    </button>
                    <button className="transition duration-200 hover:scale-110" onClick={(event) => handleChoice(event,'/avatars/avatar010.png')}>
                        <Avatar alt="Amanda Souza" src="/avatars/avatar010.png" sx={{ width: '7vw', height: '7vw', bgcolor: '#C0C0C0', fontSize: '5vw' }} />
                    </button>
                    <button className="transition duration-200 hover:scale-110" onClick={(event) => handleChoice(event,'/avatars/avatar011.png')}>
                        <Avatar alt="Amanda Souza" src="/avatars/avatar011.png" sx={{ width: '7vw', height: '7vw', bgcolor: '#C0C0C0', fontSize: '5vw' }} />
                    </button>
                    <button className="transition duration-200 hover:scale-110" onClick={(event) => handleChoice(event,'/avatars/avatar012.png')}>
