                ...
                <div className="flex justify-between">
                    <div className=" w-[25vw] h-full bg-zinc-800  ">
                        <div className="flex justify-center">
                            <FiltroPesquisa search={search} setSearch={setSearch} />
                        </div>
                    ...
                    <div className=" px-6 py-6 flex flex-col items-center w-[80vw]">
                        <div className="m-6 inline-flex items-center">
                            <input onChange={(event) => { handleChange(event) }} type="text" name="search" className="bg-[#4F545C] w-[800px] py-3 px-4 rounded-[14px] text-sm placeholder:text-zinc-400" placeholder="Pesquise um desafio" />
